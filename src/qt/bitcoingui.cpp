                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BOG Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BOGCOIN"), this);
    aboutAction->setStatusTip(tr("Show information about BOGCOIN"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BOGCOIN help message to get a list with possible BOGCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BOGCOIN client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BOGCOIN"); // default title
