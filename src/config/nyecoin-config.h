/* src/config/bogcoin-config.h.  Generated from bogcoin-config.h.in by configure.  */
/* src/config/bogcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "BOGCOIN"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BOGCOIN 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bogcoin"
