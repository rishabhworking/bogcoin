Contributing to BOGCOIN
==================================

The BOGCOIN project operates an open contributor model where anyone is
...
The following applies to code changes to the BOGCOIN project, and is not to be
confused with overall BOGCOIN Network Protocol consensus changes.

Whether a pull request is merged into BOGCOIN rests with the project merge
...
The project leader is the release manager for each BOGCOIN release.
