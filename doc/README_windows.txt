...
Intro
-----
BOGCOIN (BOG) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BOGCOIN utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bogcoin-qt.exe.

BOGCOIN is the original BOGCOIN client and it builds the backbone of the network.
However, it downloads and stores the entire history of BOGCOIN transactions;
